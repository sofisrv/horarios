...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-borderd table-hover table-striped display responsive nowrap" id="t_evento" style="width: 100%;">
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="Views\limpiezas\registroEvento.php" method="post" id="frmEvento" autocomplete="off">
