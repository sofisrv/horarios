...
class TodoModel extends Query
{
    ...
    {
        $sql = "SELECT p.id, p.hora_ini, p.hora_fin, p.fecha, pr.nombre as id_maquinaria, p.estado FROM eventos p INNER JOIN proveedor pr on p.id_maquinaria = pr.id;";
