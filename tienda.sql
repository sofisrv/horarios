...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2022 a las 01:52:46
...
CREATE TABLE `campanas` (
  ...
  `id1` int(11) NOT NULL,
  `id2` int(11) NOT NULL,
  `tiempo_campana` int(11) NOT NULL,
  `estado` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, '12345678910', 'Farmiral, '925491523', 'Mexico', 'Gracias por su preferencia');
...
(1, 'admin', 'Sofia Ruiz', 'sofiaruizvelascoa@gmail.com', '$2y$10$KGIGLWldVYJ/LSU8dCFe6.6aKLJX7clsrKs6hzcqYI.CRRBY2Zs3O', 1, '2024-01-18 17:37:50');
...
ALTER TABLE `detalle_compra`
  ...
  ADD CONSTRAINT `detalle_compra_ibfk_2` FOREIGN KEY (`folio`) REFERENCES `compras` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `detalle_ventas`
  ...
  ADD CONSTRAINT `detalle_ventas_ibfk_2` FOREIGN KEY (`folio`) REFERENCES `ventas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
